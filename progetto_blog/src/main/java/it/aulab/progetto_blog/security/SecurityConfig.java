...
public class SecurityConfig {
    ...
    public final static String cspDirectives = "default-src 'self' ; img-src 'self'; script-src 'self' cdn.jsdelivr.net 'unsafe-inline'; style-src 'self' cdn.jsdelivr.net cdnjs.cloudflare.com ; font-src cdnjs.cloudflare.com";
    @Bean
    ...
    public InMemoryUserDetailsManager userManager(){
        ...
        UserBuilder user = User.withUsername("user").password(encoder().encode("12345678")).roles("USER");
        UserBuilder admin = User.withUsername("admin").password(encoder().encode("admin12345678")).roles("ADMIN");
